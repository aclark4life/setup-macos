...
Install Corporate Ipsum widget
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

open http://www.apple.com/downloads/dashboard/developer/corporateipsum.html
open ~/Downloads/corporate-ipsum-1-1.zip
...
Users & Groups -> Alex Clark -> Login Items -> + Dropbox
